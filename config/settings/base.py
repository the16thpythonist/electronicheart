...
# electronicheart/
APPS_DIR = ROOT_DIR / "electronicheart"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "electronicheart.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "electronicheart.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Jonas Teufel""", "jonseb1998@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "electronicheart.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "electronicheart.users.adapters.SocialAccountAdapter"
